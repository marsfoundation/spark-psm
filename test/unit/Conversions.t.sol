...
contract PSMConvertToAssetValueTests is PSMConversionTestBase {
    ...
    function testFuzz_convertToAssetValue_conversionRateIncrease(
        ...
        public
    {
        MockRateProvider(address(rateProvider)).__setConversionRate(1e27);  // Start lower than 1.25 for this test
    ...
    function testFuzz_convertToAssetValue_conversionRateDecrease(
        ...
        public
    {
        MockRateProvider(address(rateProvider)).__setConversionRate(2e27);  // Start higher than 1.25 for this test
...
contract PSMConvertToSharesWithSDaiTests is PSMConversionTestBase {
        ...
        public
    {
        ...
        MockRateProvider(address(rateProvider)).__setConversionRate(1.1e27);  // Start lower than 1.25 for this test
